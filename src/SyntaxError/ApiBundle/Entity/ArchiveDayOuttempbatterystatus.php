...
/**
 * ArchiveDayOuttempbatterystatus
 *
 * @ORM\Table(name="archive_day_outTempBatteryStatus", uniqueConstraints={@ORM\UniqueConstraint(name="dateTime", columns={"dateTime"})})
 * @ORM\Entity
 */
class ArchiveDayOuttempbatterystatus
{
    /**
     * @var integer
     *
