...
/**
 * ArchiveDayIntempbatterystatus
 *
 * @ORM\Table(name="archive_day_inTempBatteryStatus", uniqueConstraints={@ORM\UniqueConstraint(name="dateTime", columns={"dateTime"})})
 * @ORM\Entity
 */
class ArchiveDayIntempbatterystatus
{
    /**
     * @var integer
     *
