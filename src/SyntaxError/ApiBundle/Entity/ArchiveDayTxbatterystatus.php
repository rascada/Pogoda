...
/**
 * ArchiveDayTxbatterystatus
 *
 * @ORM\Table(name="archive_day_txBatteryStatus", uniqueConstraints={@ORM\UniqueConstraint(name="dateTime", columns={"dateTime"})})
 * @ORM\Entity
 */
class ArchiveDayTxbatterystatus
{
    /**
     * @var integer
     *
