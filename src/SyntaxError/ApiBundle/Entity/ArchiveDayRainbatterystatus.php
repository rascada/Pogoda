...
/**
 * ArchiveDayRainbatterystatus
 *
 * @ORM\Table(name="archive_day_rainBatteryStatus", uniqueConstraints={@ORM\UniqueConstraint(name="dateTime", columns={"dateTime"})})
 * @ORM\Entity
 */
class ArchiveDayRainbatterystatus
{
    /**
     * @var integer
     *
