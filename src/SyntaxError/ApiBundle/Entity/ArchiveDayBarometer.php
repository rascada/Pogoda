 ...
 * ArchiveDayBarometer
 *
 * @ORM\Table(name="archive_day_barometer", uniqueConstraints={@ORM\UniqueConstraint(name="dateTime", columns={"dateTime"})})
 * @ORM\Entity(repositoryClass="SyntaxError\ApiBundle\Repository\ArchiveDayBarometerRepository")
 */
class ArchiveDayBarometer implements ArchiveDay
{
    /**
     * @var integer
     *
