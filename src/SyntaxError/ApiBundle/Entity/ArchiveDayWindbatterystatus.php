...
/**
 * ArchiveDayWindbatterystatus
 *
 * @ORM\Table(name="archive_day_windBatteryStatus", uniqueConstraints={@ORM\UniqueConstraint(name="dateTime", columns={"dateTime"})})
 * @ORM\Entity
 */
class ArchiveDayWindbatterystatus
{
    /**
     * @var integer
     *
