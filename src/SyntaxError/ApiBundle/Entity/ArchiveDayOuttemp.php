 ...
 * ArchiveDayOuttemp
 *
 * @ORM\Table(name="archive_day_outTemp", uniqueConstraints={@ORM\UniqueConstraint(name="dateTime", columns={"dateTime"})})
 * @ORM\Entity(repositoryClass="SyntaxError\ApiBundle\Repository\ArchiveDayOuttempRepository")
 */
class ArchiveDayOuttemp implements ArchiveDay
{
    /**
     * @var integer
     *
